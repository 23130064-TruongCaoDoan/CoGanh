...
public class AI {
	...
	public static void main(String[] args) {
		...
		// chạy thuật toán
//		ai.alphaBeta(true,root, 6, Integer.MIN_VALUE, Integer.MAX_VALUE);
//		ai.minimax(true, root, 6);
